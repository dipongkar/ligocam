...
if disfile_size > 2:
   shutil.copy2(run_dir + 'results/Disconnected_now.txt',run_dir + 'results/Disconnected_past.txt')
else:
...
if daqfile_size > 2:
   shutil.copy2(run_dir + 'results/DAQfailure_now.txt',run_dir + 'results/DAQfailure_past.txt')
else:
   print "current file is empty"
