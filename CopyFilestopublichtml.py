...
shutil.copytree(run_dir + 'images/ASD/'+strcurGpsTime, pub_dir + 'images/ASD/'+strcurGpsTime)

shutil.copytree(run_dir + 'images/TS/'+strcurGpsTime, pub_dir + 'images/TS/'+strcurGpsTime)
