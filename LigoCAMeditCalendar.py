...
stringold = '<!-- '+ymdhstring+' --> <li class="sgrayl l1"><p>'+hourstring+':00</p></li>'
stringnew = '<li class="greenish l1"><p><a href="https://ldas-jobs.ligo-wa.caltech.edu/~dtalukder/Projects/detchar/LigoCAM/PEM/pages/LigoCamHTML_'+strcurGpsTime+'.html">'+hourstring+':00</a></p></li>'



html_file = pubhtml_dir + 'calendar/LigoCAM_'+monthstring+'_'+yearstring+'.html'
html_file_temp = pubhtml_dir + 'calendar/LigoCAM_'+monthstring+'_'+yearstring+'_'+strcurGpsTime+'.html'
